...
class SendPushMessageJob implements ShouldQueue
{
    ...
    ): void
    {
        ...
        if ($this->scope === 'account' && $this->accountId !== null) {
            ...
            if (! app(\Shared\PushHandler\Contracts\PushPlanPolicyContract::class)->canSend($this->accountId, $message, $audienceSize)) {
                return;
            }
        }
