...
namespace Shared\Settings\Application;
...
use Shared\Settings\Exceptions\SettingsNamespaceNotFoundException;
...
class SettingsKernelService
{
    ...
    public function schema(string $scope, mixed $user): array
    {
        ...
        return [
            'schema_version' => (string) config('shared_settings.schema_version', '1.0.0'),
            'schema_version_policy' => (array) config('shared_settings.schema_version_policy', []),
            'namespaces' => $schema,
        ];
    }
