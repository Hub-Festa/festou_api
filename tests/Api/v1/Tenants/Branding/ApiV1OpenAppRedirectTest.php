...
class ApiV1OpenAppRedirectTest extends TestCaseTenant
{
    ...
    public function test_open_app_redirect_for_android_invite_context_uses_app_intent_with_store_fallback(): void
    {
        ...
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_ANDROID, 'com.festou.openapp');
        ...
        TenantSettings::create([
            'app_links' => [
                'android' => [
                    'enabled' => true,
                    'store_url' => 'https://play.google.com/store/apps/details?id=com.festou.openapp',
                ],
            ],
        ]);
        ...
        $this->assertSame('com.festou.openapp', $intent['package']);
    ...
    {
        $tenant = $this->makeCanonicalTenantCurrent($this->tenant);
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_ANDROID, 'com.festou.direct');
        ...
        TenantSettings::create([
            'app_links' => [
                'android' => [
                    'enabled' => true,
                    'store_url' => 'https://play.google.com/store/apps/details?id=com.festou.direct',
                ],
            ],
        ]);
        ...
        foreach ($cases as $case) {
            ...
            $this->assertSame('com.festou.direct', $intent['package']);
    ...
    {
        $tenant = $this->makeCanonicalTenantCurrent($this->tenant);
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_ANDROID, 'com.festou.openapp.detail');
        ...
        TenantSettings::create([
            'app_links' => [
                'android' => [
                    'enabled' => true,
                    'store_url' => 'https://play.google.com/store/apps/details?id=com.festou.openapp.detail',
                ],
            ],
        ]);
        ...
        $intent = $this->parseAndroidIntentLocation((string) $location);
        $this->assertSame('com.festou.openapp.detail', $intent['package']);
    ...
    {
        $tenant = $this->makeCanonicalTenantCurrent($this->tenant);
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_ANDROID, 'com.festou.openapp.inactive');
        ...
        TenantSettings::create([
            'app_links' => [
                'android' => [
                    'enabled' => false,
                    'store_url' => 'https://play.google.com/store/apps/details?id=com.festou.openapp.inactive',
                ],
            ],
        ]);
    ...
    {
        $tenant = $this->makeCanonicalTenantCurrent($this->tenant);
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_ANDROID, 'com.festou.openapp.override');
        $this->upsertTypedAppDomain($tenant, Tenant::DOMAIN_TYPE_APP_IOS, 'com.festou.ios.override');
        ...
        TenantSettings::create([
            'app_links' => [
                'android' => [
                    'enabled' => true,
                    'store_url' => 'https://play.google.com/store/apps/details?id=com.festou.openapp.override',
                ],
                'ios' => [
                    'enabled' => true,
