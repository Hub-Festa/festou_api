...
class ApiV1EnvironmentApiTest extends TestCaseTenant
{
    ...
    public function test_environment_api_exposes_public_web_metadata_from_merged_branding(): void
    {
        ...
        try {
            ...
            $response->assertStatus(200);
            $response->assertJsonPath('public_web_metadata.default_title', 'Festou fallback');
        ...
        TenantSettings::query()->updateOrCreate(
            ...
            [
                'firebase' => [
                    ...
                    'storageBucket' => 'festou.firebasestorage.app',
                ],
            ],
        );
